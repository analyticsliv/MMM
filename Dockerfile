...
ARG NEXTPUBLIC_GOOGLE_CLIENT_ID
ARG NEXTPUBLIC_GOOGLE_CLIENT_SECRET
ARG NEXTAUTH_SECRET
ARG BASE_API_URL
...
ENV NEXTPUBLIC_GOOGLE_CLIENT_ID=${NEXTPUBLIC_GOOGLE_CLIENT_ID:-""}
ENV NEXTPUBLIC_GOOGLE_CLIENT_SECRET=${NEXTPUBLIC_GOOGLE_CLIENT_SECRET:-""}
